  ...
  return (
    <DocsLayout title="Terms of Service">
      ...
      <Section title="1. Acceptance of Terms">
        <P>By accessing or using AevixChat ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree, do not use the Service.</P>
        <P>We may update these Terms from time to time. Continued use of the Service after changes constitutes acceptance of the updated Terms.</P>
      </Section>

      <Section title="2. Eligibility">
        <P>You must be at least 13 years old to use AevixChat. By using the Service, you represent that you meet this requirement. If you are under 18, you confirm you have parental or guardian consent.</P>
      </Section>
      ...
      <Section title="4. Acceptable Use">
        <P>You agree not to use AevixChat to:</P>
        <UL items={[
          ...
          'Impersonate AevixChat staff, other users, or organisations',
          'Violate any applicable laws or regulations',
        ]} />
      </Section>

      <Section title="5. User Content">
        <P>You retain ownership of content you post on AevixChat. By posting content, you grant us a non-exclusive, royalty-free licence to host, store, and display that content as necessary to operate the Service.</P>
      ...
      <Section title="7. Intellectual Property">
        <P>The AevixChat platform, logo, and branding are owned by AevixChat. You may not use our branding, copy our platform, or represent your project as officially affiliated with AevixChat without written permission.</P>
      </Section>
      ...
      <Section title="9. Disclaimer of Warranties">
        <P>AevixChat is provided "as is" without warranties of any kind. We do not guarantee that the Service will be uninterrupted, error-free, or meet your specific requirements.</P>
      </Section>

      <Section title="10. Limitation of Liability">
        <P>To the fullest extent permitted by law, AevixChat shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the Service.</P>
      </Section>
